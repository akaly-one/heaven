              ...
              {shopSection === "packs" && (
                <div className="space-y-3">
                  {(isEditMode ? displayPacks : activePacks).length === 0 ? (
                    ...
                    return (
                      <div key={pack.id} className="card-premium relative overflow-hidden" style={{ animationDelay: `${i * 50}ms` }}>
                        ...
                        <div className="p-5 pb-0">
                            ...
                            <div className="flex items-center gap-2">
                              {isEditMode ? (
                                ...
                                <div className="text-right">
                                  ...
                                  {isCurrentTier && <p className="text-[8px] font-bold uppercase" style={{ color: "var(--success)" }}>Actif</p>}
                                </div>
                              )}
                              {isEditMode && (
                          ...
                          {isEditMode ? (
                            ...
                            <ul className="space-y-1.5 mb-3">
                              {pack.features.map((f, j) => (
                                <li key={j} className="flex items-center gap-2 text-[11px]" style={{ color: "var(--text-secondary)" }}>
                                  <Check className="w-3 h-3 shrink-0" style={{ color: hex }} />
                                  {f}
                                </li>
                              ))}
                              ...
                              <div>
                                {tierBonus.multiplier > 1 ? (
                                  <p className="text-[10px] font-semibold" style={{ color: hex }}>
                                    Bonus {tierBonus.label} — {tierBonus.bonus}
                                  </p>
                                ) : (
                                  <p className="text-[10px] font-semibold" style={{ color: hex }}>
                                    🎁 {tierBonus.bonus}
                  ...
                  {isEditMode && (
                    <button onClick={handleAddPack}
                      className="w-full py-4 rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-all hover:scale-[1.01]"
