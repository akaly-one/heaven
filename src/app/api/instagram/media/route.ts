...
/**
 * Recent Instagram posts (up to 20) via Meta Graph API.
 *
 * GET /api/instagram/media?model=m1
 *   Returns : { data: [{ id, caption, media_type, media_url, thumbnail_url,
...
export async function GET(req: NextRequest) {
  ...
  const url =
    `https://graph.facebook.com/v19.0/${config.ig_business_id}/media` +
