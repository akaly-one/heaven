      ...
      <div className={`max-w-4xl mx-auto ${spacing}`}>
              ...
              <div key={phase} className="min-w-[280px] md:min-w-0 snap-start rounded-xl overflow-hidden flex flex-col"
                ...
                <button onClick={() => setExpandedPhase(isExpanded ? null : phase)}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-[8px]" style={{ color: "var(--text-muted)" }}>{meta.desc}</span>
                  </div>
                      ...
                      return (
                        <button key={step.id} onClick={() => toggleStep(step.id)}
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <span className="text-[8px] block" style={{ color: "var(--text-muted)" }}>{step.desc}</span>
                          </div>
                          <span className="text-[7px] px-1 py-0.5 rounded shrink-0" style={{ background: "var(--bg2)", color: "var(--text-muted)" }}>
                            {step.estimatedTime}
                          </span>
                        </button>
                      );
        ...
        <div className="rounded-xl overflow-hidden" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg" style={{ background: "var(--bg2)" }}>
              <span className="text-[9px] font-medium shrink-0" style={{ color: "var(--text-muted)" }}>Webhook Verify Token:</span>
          ...
          <div className="p-4 space-y-4">
                ...
                {TONE_OPTIONS.map(tone => {
                  ...
                  return (
                    <button key={tone.id} onClick={() => updateField("agentTone", tone.id)}
                      ...
                      <p className="text-[8px]" style={{ color: "var(--text-muted)" }}>{tone.desc}</p>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl" style={{ background: "var(--bg2)" }}>
              <div className="flex-1">
                ...
                <span className="text-[8px]" style={{ color: "var(--text-muted)" }}>L&apos;agent repond sans validation manuelle</span>
              </div>
            ...
            {state.autoReplyEnabled && (
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg" style={{ background: "var(--bg2)" }}>
                ...
                <span className="text-[9px] shrink-0" style={{ color: "var(--text-muted)" }}>Delai avant reponse:</span>
        ...
        <div className="rounded-xl overflow-hidden" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
          <div className="flex items-center gap-2 px-4 py-3" style={{ borderBottom: "1px solid var(--border)" }}>
            ...
            <span className="text-[9px] font-medium ml-auto px-1.5 py-0.5 rounded-md" style={{ background: "rgba(239,68,68,0.1)", color: "#EF4444" }}>
        ...
        <div className="rounded-xl overflow-hidden" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="rounded-xl p-3" style={{ background: "var(--bg2)" }}>
              <span className="text-[9px] font-bold uppercase tracking-wider block mb-2" style={{ color: "var(--text-muted)" }}>
                ...
                {[
                  ...
                  <div key={node.label} className="flex items-center gap-1.5">
                    <div className="flex items-center gap-1 px-2 py-1 rounded-md" style={{ background: `${node.color}10`, border: `1px solid ${node.color}20` }}>
                      ...
                      <span className="text-[8px] font-semibold" style={{ color: node.color }}>{node.label}</span>
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div key={stat.label} className="text-center p-2 rounded-lg" style={{ background: "var(--surface)" }}>
                  ...
                  <span className="text-[8px]" style={{ color: "var(--text-muted)" }}>{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
...
function ConfigField({ label, value, onChange, placeholder, secret }: {
  ...
  return (
    <div>
      <label className="text-[9px] font-medium block mb-1" style={{ color: "var(--text-muted)" }}>{label}</label>
